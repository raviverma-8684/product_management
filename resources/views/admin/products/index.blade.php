            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-Product">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.product.fields.is_in_stock') }}
                        </th>
                        <th>
                ...
                <tbody>
                    @foreach($product as $key => $product)
                        <tr data-entry-id="{{ $product->id }}">
                            ...
                            <td>
                                {{ $product->is_in_stock ? 'Out Of Stock' : 'In Stock' }}
                            ...
                            <td>
                                ...
                                <img class="pic" id="boy-pic" src="{{ asset($product->photo) }}" alt="Example Photo" width="90px">
